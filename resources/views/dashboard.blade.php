...
<div class="w-full flex items-center justify-center h-full">
    <div class="text-center">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">No Instance Selected</h3>
        <p class="mt-1 text-sm text-gray-500">Please select a instance or create a new one.</p>
        <div class="mt-6">
